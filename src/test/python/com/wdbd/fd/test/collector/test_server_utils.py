...
# import unittest
# import os
# from com.wdbd.fd.services.dt.server import DTServer, ActionGroup, Action
...
#         self.assertEqual(60, group.get_interval_minutes())
#         self.assertEqual(ActionGroup.BREAK, group.get_onerr_mode())
#         # check Action
...
#         self.assertEqual("com.wdbd.fd.collector.actions.demo_actions.DemoAction_A", action.class_url)
#         self.assertEqual("com.wdbd.fd.collector.actions.demo_actions", action.get_package())
#         self.assertEqual("DemoAction_A", action.get_classname())
